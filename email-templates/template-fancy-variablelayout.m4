define([[fancyvariablelayout]], [[<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
    <head>
...
.moduleContent{
	/*GREGN @editable*/ background-color:#E3E3E3;
}
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="$8" style="max-width:600px;" id="headerImage campaign-icon"/>
                                            ...
                                            <td valign="top" class="bodyContent">
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top">
                                                            <div>
                                                                <center><h3 class="h3">$4</h1></center>
                                                                <br />
                                                                $5
                                                                <br />
                                                                <br />
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%" class="moduleContent">
                                                    <tr>
                                                        <td align="center" valign="top">
                                                            <a href="http://startupbidder.com/l/345345345.html"><img src="$9" style="max-width:250px;"/></a>
                                                        </td>
                                                        <td valign="top">
                                                            <div>
                                                               <a href="http://startupbidder.com/l/345345345.html"><h2 class="h2">Social Recommendations</h2></a>
 	                                                       <h4 class="h4">INTERNET <br>London, UK</h4>
                                                               Identifying with your peer group through joint purchases.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
