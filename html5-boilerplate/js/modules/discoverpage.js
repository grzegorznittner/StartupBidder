    ...
    loadPage: function() {
        var completeFunc = function(json) {
                var header = new HeaderClass(),
                    ...
                    usersListings = new CompanyListClass({ propertykey: 'users_listings', companydiv: 'users_listings', seeall: '/main-page.html?type=useractive' }),
                    monitoredListings = new CompanyListClass({ propertykey: 'monitored_listings', companydiv: 'monitored_listings', seeall: '/main-page.html?type=monitored' }),
