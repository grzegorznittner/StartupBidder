`
        ...
        <div class="initialhidden" id="last_bids_wrapper">

        <div class="sidebox orderbook lastorder">
            <div>Last Bid</div>
            <div class="lastorderamt" id="last_investor_bids_amt"></div>
            <div id="last_investor_bids_details"></div>
            <div id="last_investor_bids_date"></div>
        </div>

        <div class="sidebox orderbook lastorder">
            <div>Last Ask</div>
            <div class="lastorderamt" id="last_owner_bids_amt"></div>
            <div id="last_owner_bids_details"></div>
            <div id="last_owner_bids_date"></div>
        </div>

        <div class="sidebox orderbooklast lastorder">
            <div>Last Sale</div>
            <div class="lastorderamt" id="last_accepted_bids_amt"></div>
            <div id="last_accepted_bids_details"></div>
            <div id="last_accepted_bids_date"></div>
        </div>
