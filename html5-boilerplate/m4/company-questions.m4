`
    <div class="span-24 initialhidden" id="qandaswrapper">
        <div class="boxtitlegap smokegrey clear">QUESTIONS AND ANSWERS WITH THE OWNER
        ...
        <div class="boxpanel boxpanelfull" id="qandalistparent">
            <div class="messageline messagereplyline questionaskline initialhidden" id="addqandabox">
                ...
                <textarea class="textarea messagetextarea messagereplytextarea" id="addqandatext" name="addqandatext" cols="20" rows="5">Put your question to the owner here...</textarea>
