    ...
    <div class="bmccell">
        ...
        <div class="bmcsection">
            ...
            <p class="bmcinfo bmcinfokeypartners">
                <label class="bmcsection">Key Partners</label>
                <br />
        ...
        <div class="bmccell">
            ...
            <div class="bmcsection">
                ...
                <p class="bmcinfo bmcinfokeyactivities">
                    <label class="bmcsection">Key Activities</label>
                    <br />
        ...
        <div class="bmccell">
            ...
            <div class="bmcsection">
                ...
                <p class="bmcinfo bmcinfokeyresources">
                    <label class="bmcsection">Key Resources</label>
                    <br />
    ...
    <div class="bmccell">
        ...
        <div class="bmcsection">
            ...
            <p class="bmcinfo bmcinfovaluepropositions">
                <label class="bmcsection">Value Propositions</label>
                <br />
        ...
        <div class="bmccell">
            ...
            <div class="bmcsection">
                ...
                <p class="bmcinfo bmcinfocustomerrelationships">
                    <label class="bmcsection">Customer Relationships</label>
                    <br />
        ...
        <div class="bmccell">
            ...
            <div class="bmcsection">
                ...
                <p class="bmcinfo bmcinfochannels">
                    <label class="bmcsection">Channels</label>
                    <br />
    ...
    <div class="bmccell">
        ...
        <div class="bmcsection">
            ...
            <p class="bmcinfo bmcinfocustomersegments">
                <label class="bmcsection">Customer Segments</label>
                <br />
    ...
    <div class="bmccell">
        ...
        <div class="bmcsection">
            ...
            <p class="bmcinfo bmcinfocoststructure">
                <label class="bmcsection">Cost Structure</label>
                <br />
    ...
    <div class="bmccell">
        ...
        <div class="bmcsection">
            ...
            <p class="bmcinfo bmcinforevenuestreams">
                <label class="bmcsection">Revenue Streams</label>
                <br />
