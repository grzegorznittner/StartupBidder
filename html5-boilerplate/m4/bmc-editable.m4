...
<div class="boxtitle bmctitle">
    ...
    <span class="bmctitleboxbtn"><div id="answer3icon"></div></span>
...
<div class="bmctallcolumnonedge bmcthreefourthsheight bmcfifthwidthminushalfbar bmccontainer">
    <div class="bmccell">
        <div class="bmcinfobtnwrap"><div class="bmcinfobtn"></div></div>
        ...
        <div class="bmcsection">
            ...
            <p class="bmcinfo bmcinfokeypartners">Who are your vendors?  Who are you buying products and services from?  Who will you use in the future?  Do you have a line of credit with them?  What sort of quantities are you committed to?  What sort of quantites can they ramp up to?  Do you plan to change suppliers?  Do you have a broad group of suppliers to chose from or is there only one for the particular input you need? In order to optimize operations and reduce risks of a business model, organization usually cultivate buyer-supplier relationships so they can focus on their core activity. Complementary business alliances also can be considered through joint ventures, strategic alliances between competitors or non-competitors.</p>
        </div>
    ...
    <div class="bmcshortcolumn bmcfifthwidthminusbar bmcthreeeighthsheightminushalfbar bmccontainer">
        <div class="bmccell">
            ...
            <div class="bmcsection">
                ...
                <p class="bmcinfo bmcinfochannels">No business is a vacuum.  How do you reach the customer?  Is there a web site, app market, catalog, pyramid marketing, salesforce, physical storefront?  What affiliates and distributors will help market and deliver your product?  Are there agents involved in the relationship?  A company can deliver its value proposition to its targeted customers through different channels. Effective channels will distribute a company’s value proposition in ways that are fast, efficient and cost effective. An organization can reach its clients either through its own channels (store front), partner channels (major distributors), or a combination of both.</p>
            </div>
